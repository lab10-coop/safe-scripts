...
fun main(args: Array<String>) {
    ...
    val exampleErc20Token = "0xf6ef10e21166cf2e33db070affe262f90365e8d4" // SFAU on tau1
    // we want to send 0.1 tokens.
    val amountToBeSent = Convert.toWei("0.1", Convert.Unit.ETHER).toBigInteger()
    ...
    val erc20 = ERC20.load(exampleErc20Token, web3, ReadonlyTransactionManager(web3, safeAddr), gasProvider)
    ...
    val to: String = exampleErc20Token
